...
<Info>
  The refund amount is not validated against previous charges. The merchant can
  refund any amount they choose, including partial refunds. The merchant must
  have sufficient token balance to cover the refund.
</Info>
