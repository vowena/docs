...
<Note>
  Rejecting a migration has no side effects. The subscription continues as
  normal on the current plan, billing proceeds unchanged, and the subscriber can
  still cancel at any time.
</Note>
