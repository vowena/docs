...
description: "Step-by-step guide for merchants using the Vowena Dashboard. Create plans, share them with subscribers, monitor billing, issue refunds, and configure auto-charging."
---
...
<Steps>
  <Step title="Connect Your Wallet">
    Visit [app.vowena.xyz](https://app.vowena.xyz) and click **Connect Wallet** in the top right corner. The dashboard will prompt Freighter (or your installed Stellar wallet) to authorize the connection.
  ...
  <Step title="Share Your Plan">
    ...
    ```
    https://app.vowena.xyz/subscribe/{PLAN_ID}
    ```
