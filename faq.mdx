...
<AccordionGroup>
  ...
  <Accordion title="Can I run my own keeper?">
    **Yes.** The standalone keeper bot lives at `sdk/keeper/src/index.ts`. Configure it with your contract ID and a funded Stellar keypair, then run it on a schedule. See the [Keeper Setup guide](/dashboard/keeper-setup) for details.
  </Accordion>
