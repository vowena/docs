...
description: "Step-by-step guide to building, deploying, and initializing the Vowena smart contract on Stellar's Soroban platform - for both testnet and mainnet."
---
...
<Steps>
  ...
  <Step title="Create your first plan">
    ...
    <Tip>
      On testnet, you can get test USDC from the [Stellar testnet faucet](https://laboratory.stellar.org). Use the test token address for the `--token` parameter.
    </Tip>
  </Step>
</Steps>
