...
<Columns cols={2}>
  ...
  <Card title="For merchants" icon="file-invoice">
    The on-chain event serves as an immutable accounting record. Integrate with the [SDK event listener](/sdk/events) to sync refunds to your accounting system.
  </Card>
</Columns>
