...
<AccordionGroup>
  ...
  <Accordion title="Is it refundable?">
    Cancellation does not trigger an automatic refund. The current period is already paid. Merchants can issue voluntary [refunds](/protocol/refunds) separately.
  </Accordion>
</AccordionGroup>
