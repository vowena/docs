...
<Info>
  This guide uses the Vowena TypeScript SDK. You'll need Node.js 18+ and a
  Stellar account with USDC.
</Info>
...
const cancelTx = await client.buildCancel(
  "GSUB...ADDR",
  subResult.subscriptionId,
);
...
<CardGroup cols={2}>
  <Card title="Core Concepts" icon="lightbulb" href="/concepts">
    Understand plans, subscriptions, allowances, and the billing lifecycle in
    depth.
  </Card>
  <Card title="How It Works" icon="diagram-project" href="/how-it-works">
    Visual walkthrough of the full protocol flow - from plan creation to
    cancellation.
  </Card>
  <Card title="SDK Reference" icon="npm" href="/sdk/client">
    Complete SDK documentation with all methods, types, and configuration
    options.
  </Card>
