...
<Info>
  This guide uses the Vowena TypeScript SDK. You'll need Node.js 18+ and a Stellar testnet account with USDC. You can get testnet USDC from the [Stellar Laboratory](https://laboratory.stellar.org/).
</Info>
