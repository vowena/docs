...
<Steps>
  <Step title="Fund a Keeper Wallet">
    Create a new Stellar keypair and fund it with a small amount of XLM for transaction fees. On testnet, use the [Stellar Friendbot](https://laboratory.stellar.org/).
